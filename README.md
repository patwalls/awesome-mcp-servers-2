...
- <img src="https://pulse.walls.sh/favicon.svg" height="14"/> [Pulse](https://github.com/patwalls/pulse-mcp) - Social-post metrics from a URL — views, likes, comments, shares, and followers across YouTube, X/Twitter, TikTok, Bluesky, and Instagram. Free, no API key.
