...
- <img src="https://superhighway.walls.sh/favicon.ico" height="14"/> [Superhighway](https://github.com/patwalls/superhighway-mcp) - Web search for AI agents: search, news, images, scrape, research. Pay-per-call in USDC via x402 or free API key (1,000 calls/month). `npx -y superhighway-mcp`
